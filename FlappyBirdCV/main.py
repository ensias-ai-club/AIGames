...
VID_CAP.set(cv.CAP_PROP_FRAME_WIDTH, 1920)
VID_CAP.set(cv.CAP_PROP_FRAME_HEIGHT, 1080)
...
with mp_face_mesh.FaceMesh(
    ...
    while True:
        ...
        if pipeSpawnTimer == 0:
            ...
            print(window_size)
            top.x, top.y = window_size[0], random.randint(120 - 900, window_size[1] - 120 - space_between_pipes - 900)
